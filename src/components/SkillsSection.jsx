  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-full relative z-10">
        ...
        <div className={`mb-12 sm:mb-16 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="flex items-center justify-center mb-6 sm:mb-8 px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              {certifications.slice(0, 3).map((cert, index) => (
                <div 
                  ...
                  className={`glass-effect p-4 rounded-lg cursor-pointer group hover:card-glow-intense transition-all duration-300 transform hover:scale-105 ${skillsAnimated ? 'animate-slide-up' : 'opacity-0'}`}
